...
export function validateAndCalculateTotal(lines, items) {
...
export function checkForDiscrepancy(items, extractedTotal) {
    const calculatedTotal = items.reduce((sum, item) => sum + item.totalPrice, 0);
...
export function detectDiscrepancy(extractedTotal, calculatedTotal, items) {
...
export function extractCommonDate(lines) {
    const datePatterns = [
