...
import { CategoryItemsDialog } from "@/components/CategoryItemsDialog";
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-2 gap-4">
          {categories?.map((category) => {
            ...
            return (<Card key={category.name} className="hover:bg-accent/50 transition-colors cursor-pointer" style={{ borderColor: category.color }} onClick={() => setSelectedCategory({
                    name: category.name,
