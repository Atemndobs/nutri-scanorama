...
export const ReceiptImageViewer = ({ receiptId, open, onClose }) => {
    ...
    return (<Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-4xl">
        ...
        <div className="relative w-full bg-white rounded-lg overflow-hidden" style={{ maxHeight: '85vh' }}>
          ...
          {error && (<div className="absolute inset-0 flex items-center justify-center text-red-500">
              {error}
            </div>)}
          
          {imageUrl && !loading && (<img src={imageUrl} alt="Receipt" className="w-full h-full object-contain" style={{ maxHeight: '80vh' }} onError={(e) => {
...
//# sourceMappingURL=ReceiptImageViewer.jsx.map